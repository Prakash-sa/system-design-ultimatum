...
| Edge | APIs | Compute | Data Stores | Messaging | Search/Data | Ops |
|---|---|---|---|---|---|---|
| [**DNS**](#dns) | [**REST**](#rest) | [**Docker**](#docker) | [**PostgreSQL** **MySQL** **Aurora**](#postgresql-mysql-aurora) | [**Kafka**](#kafka) | [**Elasticsearch** **OpenSearch**](#elasticsearch-opensearch) | [**Observability**](#observability) |
| [**CDN**](#cdn) | [**gRPC**](#grpc) | [**Kubernetes**](#kubernetes) | [**Redis**](#redis) | [**SQS** **RabbitMQ** **Celery**](#sqs-rabbitmq-celery) | [**Spark**](#spark) | [**CI CD**](#ci-cd) |
| [**Load Balancer**](#load-balancer) | [**GraphQL**](#graphql) | [**Service Mesh**](#service-mesh) | [**DynamoDB**](#dynamodb) | [**SNS** **EventBridge** **PubSub**](#sns-eventbridge-pubsub) | [**Flink** **Kafka Streams**](#flink-kafka-streams) | [**Deployment Strategies**](#deployment-strategies) |
| [**API Gateway**](#api-gateway) | [**WebSocket** **SSE**](#websocket-sse) | [**Lambda**](#lambda) | [**Cassandra**](#cassandra) | [**ZooKeeper** **KRaft**](#zookeeper-kraft) | [**Data Warehouse OLAP**](#data-warehouse-olap) | [**Infrastructure as Code**](#infrastructure-as-code) |
| [**Rate Limiter**](#rate-limiter) | [**OAuth OIDC JWT SSO**](#oauth-oidc-jwt-sso) | [**HPC Slurm MPI GPU**](#hpc-slurm-mpi-gpu) | [**MongoDB**](#mongodb) | [**Airflow** **Temporal**](#airflow-temporal) | [**Vector Database RAG**](#vector-database-rag) | [**Secrets and KMS**](#secrets-and-kms) |
| [**Object Storage S3**](#object-storage-s3) |  |  | [**Database Indexes**](#database-indexes) |  | [**Geospatial Indexing**](#geospatial-indexing) |  |
